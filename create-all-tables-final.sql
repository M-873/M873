-- Fixed SQL script - creates function before policies
-- Comprehensive fix for all missing tables and RLS policies

-- Step 1: Create the has_role function FIRST (before any policies use it)
...
-- Step 5: Create RLS policies (now the has_role function exists)
