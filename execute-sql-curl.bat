...
echo Using provided Service Role Key...
...
curl -X POST "https://mgkarabtbhluvkrfyrmu.supabase.co/rest/v1/rpc/exec_sql" ^
  -H "Authorization: Bearer sb_secret_MqFRm6SaKZlVJ_waYkyFsQ_IsNhfcTc" ^
  -H "apikey: sb_secret_MqFRm6SaKZlVJ_waYkyFsQ_IsNhfcTc" ^
